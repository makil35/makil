...
import monogram from "@/assets/logo-makil-monogram.jpg";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <img src={monogram} alt="Makil-Maqil" className="h-20 w-20 object-contain mix-blend-screen" />
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-xs">
              <li className="flex items-center space-x-2 text-background/40">
                ...
                <span>richard@makil-maqil.com</span>
              </li>
              <li className="flex items-center space-x-2 text-background/40">
