...
export const useSeo = ({ routeKey, titleKey, descriptionKey }: SeoOptions) => {
  ...
  useEffect(() => {
    ...
    const keywords = "ultra-luxury, confidential luxury, MAKIL, Makil-Herrero Richard, bespoke experiences, art of living, private clientele, discretion, excellence, Paris, Monaco, Saint-Tropez, French Riviera, Geneva, London, Dubai";
